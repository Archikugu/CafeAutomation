namespace CafeOtomasyonu.WinForms.RaporFormlari
{
	partial class frmDashboard
	{
		...
		private void InitializeComponent()
		{
			...
			this.dashboardDesigner1.Size = new System.Drawing.Size(1384, 531);
			...
			this.ribbonControl1.Size = new System.Drawing.Size(1384, 183);
			...
			// 
			this.imageAlignmentTopLeftBarItem1.Id = 257;
			...
			// 
			this.imageAlignmentCenterLeftBarItem1.Id = 258;
			...
			// 
			this.imageAlignmentBottomLeftBarItem1.Id = 259;
			...
			// 
			this.imageAlignmentTopCenterBarItem1.Id = 260;
			...
			// 
			this.imageAlignmentCenterCenterBarItem1.Id = 261;
			...
			// 
			this.imageAlignmentBottomCenterBarItem1.Id = 262;
			...
			// 
			this.imageAlignmentTopRightBarItem1.Id = 263;
			...
			// 
			this.imageAlignmentCenterRightBarItem1.Id = 264;
			...
			// 
			this.imageAlignmentBottomRightBarItem1.Id = 265;
			...
			// imageLoadBarItem1
			// 
			this.imageLoadBarItem1.Id = 296;
			this.imageLoadBarItem1.Name = "imageLoadBarItem1";
			// 
			// imageImportBarItem1
			// 
			this.imageImportBarItem1.Id = 297;
			...
			this.increaseIndentItem1.Id = 346;
			...
			this.insertFloatingPictureItem1.Id = 380;
			...
			this.insertTableColumnToLeftItem1.Id = 423;
			...
			this.insertTableColumnToRightItem1.Id = 424;
